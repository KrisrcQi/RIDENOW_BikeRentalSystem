...
class RentBike:
    ...
    def frent(self):
        ...
        # place combs:
        self.comb_location.place(x=S_W * 600/1440, y=S_H * 200/900, width=S_W * (500/1440), height=S_H * (40/900))
    ...
    def fcurrent_riding(self):
        ...
        # place button:
        self.btn_return_bike.place(x=S_W*200/1440, y=S_H * 750/900, width=S_W * (200/1440), height=S_H * (40/900))
    ...
    def fmake_payment(self):
        ...
        self.l_start_time_show_2 = Label(self.frame_make_payment, text='{}'.format(self.payment_info_data[4]), font=FONT)
        self.l_end_time_show_2 = Label(self.frame_make_payment, text='{}'.format(self.payment_info_data[5]), font=FONT)
        self.l_riding_time_show_2 = Label(self.frame_make_payment, text='{}'.format(self.payment_info_data[6]), font=FONT)
...
class My:
    ...
    def fpayment_selection(self):
        ...
        self.optionmenu_card.place(x=S_W * (50 / 140), y=S_H * 650/1440, width=S_W * (300/1440), height=S_H * (50/900))
    ...
    def fchange_password(self):
        ...
        # create labels:
        self.l_change_password_title = Label(self.frame_change_password, text="Please enter your current password", font=FONT_TOP)
        # create Entry:
