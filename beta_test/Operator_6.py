...
class Track:
    ...
    def ftrack_main(self):
        ...
        self.btn_riding.place(x=S_W / 1440 * 350, y=S_H / 900 * 150, height=50, width=300)

        self.btn_parking = Button(self.frame_track_main, text='In Parking Lot',
                                  command=self.show_parking_tabel, font=FONT)
        self.btn_parking.place(x=S_W / 1440 * 800, y=S_H / 900 * 150, height=50, width=300)
...
class Move:
    ...
    def fmove_history(self):
        ...
        # self.btn_confirm = Button(self.frame_move_history, text="Fliter", font=FONT,
        #                           command=self.show_move_history_tabel)
...
class MoveDetails:
    ...
    def init_ui(self):
        ...
        self.c_moveto = ttk.Combobox(self.master,font=font,
                                     values=self.get_location(),textvariable=mlocation)
