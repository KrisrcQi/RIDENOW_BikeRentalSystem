...
class Charge:
    ...
    def fcharge_main(self):
        ...
        self.comb_location = ttk.Combobox(self.frame_charge_main,values=self.select_location(),font=FONT)
        ...
        self.comb_type = ttk.Combobox(self.frame_charge_main,values = ["Electric Bike", "Foot Bike"],font=FONT)
        ...
        # self.btn_selectall.place(x=S_W/1440*150, y=S_H/900*700, width=WIDTH, height=HEIGHT)
        #
        # self.btn_charge = Button(self.frame_charge_main, text="Charge", font=FONT,
        #                             command=self.show_frame_charge_confirm)
        # self.btn_charge.place(x=S_W/1440*950, y=S_H/900*700, width=WIDTH, height=HEIGHT)
    ...
    def fcharge_history(self):
        ...
        self.comb_day = ttk.Combobox(self.frame_charge_history,values = self.day,font=FONT)
        self.comb_day.insert(0, "day")
        self.comb_day.place(x=S_W/1440*(150 + 150), y=S_H/900*200, width=WIDTH/3, height=HEIGHT)
        self.comb_month = ttk.Combobox(self.frame_charge_history,values = self.month,font=FONT)
        self.comb_month.insert(0, "month")
        self.comb_month.place(x=S_W / 1440 * (150 + 150)+WIDTH / 3, y=S_H / 900 * 200, width=WIDTH / 3, height=HEIGHT)
        self.comb_year = ttk.Combobox(self.frame_charge_history,values = self.year,font=FONT)
        self.comb_year.insert(0, "year")
        self.comb_year.place(x=S_W / 1440 * (150 + 150)+2*WIDTH / 3, y=S_H / 900 * 200, width=WIDTH / 3, height=HEIGHT)
        ...
        self.comb_type = ttk.Combobox(self.frame_charge_history,values = ["Electric Bike", "Foot Bike"],font=FONT)
        ...
        columns = ['No.', 'Bike ID', 'Bike Type', 'ChargeTime', 'Location']
...
class ChargeTable(ttk.Treeview, Charge):
    ...
    def __init__(self, master, columns) -> None:
        ...
        self.datas = []  # 保存表中的数据
        self.add_row(['1', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['2', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['3', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['4', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['5', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['6', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['7', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['8', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['9', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['10', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['11', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['12', '1002', 'type1', "20%", "Main Building", "time"])
        self.add_row(['13', '1002', 'type1', "20%", "Main Building", "time"])


    def getChargeData(self):
        chargeList = OperatorDatabase()
        chargeData = chargeList.get_chargeData(self.comb_location, self.comb_type)
        return chargeData
...
class ChargeHistoryTable(ttk.Treeview):
    def __init__(self, master, columns) -> None:
        ...
        self.datas = []  # 保存表中的数据
        self.add_row(['1', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['2', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['3', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['4', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['5', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['6', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['7', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['8', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['9', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['10', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['11', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['12', 'h1002', 'type1', "date", "Main Building", "operator1"])
        self.add_row(['13', 'h1002', 'type1', "date", "Main Building", "operator1"])
...
class Repair:
    ...
    def frepair_main(self):
        ...
        self.l_location.place(x=S_W/1440* 150, y=S_H/900*150)
        self.comb_location = ttk.Combobox(self.frame_repair_main,values=self.select_location(),font=FONT)
        self.comb_location.place(x=S_W/1440*(150+150), y=S_H/900*150, width=WIDTH, height=HEIGHT)

        self.l_type = Label(self.frame_repair_main, text='Bike Type:', font=FONT)
        self.l_type.place(x=S_W/1440*(300+WIDTH+150), y=S_H/900*150)
        self.comb_type = ttk.Combobox(self.frame_repair_main,values = ["Electric Bike", "Foot Bike"],font=FONT)
        self.comb_type.place(x=S_W/1440*(300+WIDTH+300), y=S_H/900*150, width=WIDTH, height=HEIGHT)
    ...
    def frepair_history(self):
        ...
        self.l_date.place(x=S_W/1440*150, y=S_H/900*200)
        self.comb_day = ttk.Combobox(self.frame_repair_history, values=self.day, font=FONT)
        self.comb_day.insert(0, "day")
        self.comb_day.place(x=S_W/1440*(150 + 150), y=S_H/900*200, width=WIDTH / 3, height=HEIGHT)
        self.comb_month = ttk.Combobox(self.frame_repair_history, values=self.month, font=FONT)
        self.comb_month.insert(0, "month")
        self.comb_month.place(x=S_W/1440*((150 + 150) + WIDTH / 3), y=S_H/900*200, width=WIDTH / 3, height=HEIGHT)
        self.comb_year = ttk.Combobox(self.frame_repair_history, values=self.year, font=FONT)
        self.comb_year.insert(0, "year")
        self.comb_year.place(x=S_W/1440*((150 + 150) + 2* WIDTH / 3), y=S_H/900*200, width=WIDTH / 3, height=HEIGHT)

        self.l_type = Label(self.frame_repair_history, text='Bike Type:', font=FONT)
        self.l_type.place(x=S_W/1440*(300 + WIDTH + 150), y=S_H/900*200)
        self.comb_type = ttk.Combobox(self.frame_repair_history,values = ["Electric Bike", "Foot Bike"],font=FONT)
        self.comb_type.place(x=S_W/1440*(300 + WIDTH + 300), y=S_H/900*200, width=WIDTH, height=HEIGHT)
...
class RepairTable(ttk.Treeview):
    ...
    def __init__(self, master, columns) -> None:
        ...
        self.datas = []  # 保存表中的数据
        self.add_row(['1', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['2', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['3', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['4', 'r1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['5', 'r1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['6', 'r1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['7', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['8', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['9', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['10', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['11', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['12', 'r1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['13', 'r1002', 'type1', "AAA", "Main Building", "time"])
...
class RepairHistoryTable(ttk.Treeview):
    ...
    def __init__(self, master, columns) -> None:
        ...
        self.datas = []  # 保存表中的数据
        self.add_row(['1', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['2', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['3', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['4', 'rh1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['5', 'rh1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['6', 'rh1002', 'type1', "BBB", "Main Building", "time"])
        self.add_row(['7', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['8', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['9', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['10', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['11', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['12', 'rh1002', 'type1', "AAA", "Main Building", "time"])
        self.add_row(['13', 'rh1002', 'type1', "AAA", "Main Building", "time"])
