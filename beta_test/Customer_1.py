...
class Report:
    ...
    def submit(self):
        ...
        c.execute("""insert into report (username,report_time,location,err_type,Desc,img_path,Status) values(?,?,?,?,?,?,?)""",
...
class My:
    ...
    def confirm_pay(self):
        click = messagebox.askyesno("Successful Payment!")
        if click:
            self.show_frame_my()
    ...
    def confirm_new_password(self):
        ...
        new_entry = self.e_new_password
        repeat_entry = self.e_repeat_password
        if new_entry == repeat_entry:
            messagebox.askyesno("Success!")
        else:
            messagebox.askyesno("Passwords are not matched!")

    def fmy(self):

        # create labels:
        self.l_user_id = Label(self.frame_my, text="User ID: ", font=FONT)
        self.l_user_id_show = Label(self.frame_my, text="", font=FONT)
        self.l_user_name = Label(self.frame_my, text="Username: ", font=FONT)
        self.l_user_name_show = Label(self.frame_my, text="", font=FONT)
        self.l_email = Label(self.frame_my, text="E-mail: ", font=FONT)
        self.l_email_show = Label(self.frame_my, text="", font=FONT)
        self.l_account_credit = Label(self.frame_my, text="Account credit: ", font=FONT)
        self.l_account_credit_show = Label(self.frame_my, text="", font=FONT)
    ...
    def fpayment_selection(self):
        ...
        self.optionmenu_card = OptionMenu(self.frame_payment_selection, selected_card, *cards)
    ...
    def fconfirm_payment_info(self):
        ...
        self.l_user_id_show = Label(self.frame_confirm_payment_info, text="", font=FONT)
        self.l_user_name = Label(self.frame_confirm_payment_info, text="Username: ", font=FONT)
        self.l_user_name_show = Label(self.frame_confirm_payment_info, text="", font=FONT)
        self.l_amount = Label(self.frame_confirm_payment_info, text="Amount: ", font=FONT)
        self.l_amount_show = Label(self.frame_confirm_payment_info, text="", font=FONT)
        self.l_top_up_account = Label(self.frame_confirm_payment_info, text="Top-up Account: ", font=FONT)
        self.l_top_up_account_show = Label(self.frame_confirm_payment_info, text="", font=FONT)
        self.l_card_info = Label(self.frame_confirm_payment_info, text="Card: ", font=FONT)
        self.l_card_info_show = Label(self.frame_confirm_payment_info, text="", font=FONT)
    ...
    def ftransaction_history(self):
        ...
        # create options:
        selected_transaction_type = StringVar()
        types = ["Paied", "Top_up"]
        self.optionmenu_transaction_type = OptionMenu(self.frame_transaction_history, selected_transaction_type, *types)
        ...
        self.transaction_list.place(x=S_W * (2 / 14), y=S_H * (27 / 90), width=1000, height=300)
        self.btn_go_back.place(x=S_W * (2 / 14), y=S_H * (60 / 90), width=150, height=50)
    ...
    def frent_history(self):
        ...
        self.l_rent_date = Label(self.frame_rent_history, text="Date: ", font=FONT)
        # create options:
        selected_rentbike_type = StringVar()
        types = ["Electric bike", "Foot bike"]
        self.optionmenu_bike_type = OptionMenu(self.frame_rent_history, selected_rentbike_type, *types)
        selected_rent_date = StringVar()
        dates = ["Oct 2", "Oct 1", "Sep 30"]
        self.optionmenu_rent_date = OptionMenu(self.frame_rent_history, selected_rent_date, *dates)
        # create list:
        ...
        self.optionmenu_rent_date.place(x=S_W * (88 / 140), y=S_H * (14 / 90), width=300, height=50)
    ...
    def freport_history(self):
        ...
        types = ["Electric bike", "Foot bike"]
        self.optionmenu_bike_type = OptionMenu(self.frame_report_history, selected_bike_type, *types)
        selected_report_type = StringVar()
        error_types = ["Wheels", "Handle", "Front", "brakes", "Seat", "Frame", "Flywheel", "Chain"]
        self.optionmenu_report_type = OptionMenu(self.frame_report_history, selected_report_type, *error_types)
        # create list:
        ...
        self.optionmenu_bike_type.place(x=S_W * (32 / 140), y=S_H * (143 / 900), width=300, height=50)
    ...
    def fnew_password(self):
        ...
        self.l_enter_new_password.place(x=S_W * (45 / 140), y=S_H * (31 / 90))
