...
class Charge:
    ...
    def show_charge_tabel_l(self,event):
        ...
        self.table = ChargeTable(self.frame_charge_main, columns=columns,
                                 ...
                                 comb_type="electric_bike")
        print(self.selected_location.get(), self.selected_type1.get())
    ...
    def show_charge_tabel(self,event):
        ...
        self.table = ChargeTable(self.frame_charge_main, columns=columns,
                                 comb_location=self.selected_location.get(),
                                 comb_type=self.selected_type1.get())
        print(self.selected_location.get(), self.selected_type1.get())
        self.table.place(x=S_W / 1440 * 150, y=S_H / 900 * 300)
    ...
    def show_charge_history_tabel(self,event):
        ...
        # date_string=str(self.date_entry.get())
        # date_parts = date_string.split('/')
        # self.date = "{}-{}-{}".format(date_parts[2], date_parts[0], date_parts[1])
        # print(self.date)
        # print(type(self.date))

        self.table = ChargeHistoryTable(self.frame_charge_history, columns=columns,
                                        comb_date=self.date,
                                        comb_type=self.selected_type2.get())
        self.table.place(x=S_W / 1440 * 150, y=S_H / 900 * 300)
    ...
    def fcharge_main(self):
        ...
        self.comb_location.bind("<<ComboboxSelected>>",self.show_charge_tabel_l)
        ...
        self.btn_confirm.place(x=S_W / 1440 * (2* WIDTH + 650), y=S_H / 900 * 150, width=WIDTH/3, height=HEIGHT)
    ...
    def fcharge_history(self):
        ...
        # self.l_date = Label(self.frame_charge_history, text='Date:', font=FONT)
        # self.l_date.place(x=S_W / 1440 * 150, y=S_H / 900 * 200)
        # self.date_entry=DateEntry(self.frame_charge_history,font=FONT)
        # self.date_entry.place(x=S_W / 1440 * (150 + 150), y=S_H / 900 * 200, width=WIDTH,height=HEIGHT)
        ...
        self.btn_confirm.place(x=S_W / 1440 * (2*WIDTH + 650), y=S_H / 900 * 200, width=WIDTH/3, height=HEIGHT)
...
class ChargeTable(ttk.Treeview, Charge):
    ...
    def __init__(self, master, columns,
                 comb_location="ARC", comb_type="electric_bike") -> None:
        super().__init__(
            master=master,
            columns=columns,
            show='headings',
...
class ChargeHistoryTable(ttk.Treeview):
    def __init__(self, master, columns,
                 comb_date="2023-10-22", comb_type="electric_bike") -> None:
        super().__init__(
            master=master,
            columns=columns,
            show='headings',
    ...
    def getChargeHistoryData(self):
        ...
        Oid=chargeHistList.get_loginData()[2]
        chargeHistoryData = chargeHistList.get_chargeHistory(self.cd, self.ct,Oid)
...
class Repair:
    ...
    def show_repair_tabel(self,event):
        ...
        self.table = RepairTable(self.frame_repair_main, columns=columns,
                                 comb_location=self.selected_location.get(),
                                 comb_type=self.selected_type3.get())
        self.table.place(x=S_W / 1440 * 150, y=S_H / 900 * 300)

    def show_repair_tabel_l(self, event):
        S_W = self.master.winfo_screenwidth()
        S_H = self.master.winfo_screenheight()
    ...
    def show_repair_history_tabel(self,event):
        ...
        self.table = RepairHistoryTable(self.frame_repair_history, columns=columns,
                                        comb_date=self.date,
                                        comb_type=self.selected_type.get())
        self.table.place(x=S_W / 1440 * 150, y=S_H / 900 * 300)
    ...
    def frepair_main(self):
        ...
        self.comb_location.set("Choose Location")
        self.comb_location.place(x=S_W / 1440 * (150 + 150), y=S_H / 900 * 150, width=WIDTH, height=HEIGHT)
        self.comb_location.bind("<<ComboboxSelected>>", self.show_repair_tabel_l)

        self.selected_type3 = StringVar()
        self.l_type = Label(self.frame_repair_main, text='Error Type:', font=FONT)
        self.l_type.place(x=S_W / 1440 * (300 + WIDTH + 150), y=S_H / 900 * 150)
        self.comb_type = ttk.Combobox(self.frame_repair_main, values=list(self.select_errortype()),
        ...
        self.comb_type.bind("<<ComboboxSelected>>", self.show_repair_tabel)

        self.btn_confirm = Button(self.frame_repair_main, text="Fliter", font=FONT,
                                  command=self.show_repair_tabel)
        self.btn_confirm.place(x=S_W / 1440 * (650 + 2*WIDTH), y=S_H / 900 * 150, width=WIDTH/3, height=HEIGHT)
    ...
    def frepair_history(self):
        ...
        self.btn_confirm.place(x=S_W / 1440 * (650 + 2*WIDTH), y=S_H / 900 * 200, width=WIDTH/3, height=HEIGHT)
...
class RepairTable(ttk.Treeview, Repair):
    ...
    def __init__(self, master, columns,
                 comb_location="ARC", comb_type="Wheel") -> None:
        super().__init__(
            master=master,
            columns=columns,
            show='headings',
...
class RepairDetail:
    ...
    def __init__(self, no=None, BID=None, BType=None, Errortype=None,
                 Location=None, time=None, date=None) -> None:
        self.no = no
        self.BID = BID
        self.BType = BType
...
class RepairDetails:
    ...
    def init_ui(self):
        ...
        self.l_battery = Label(self.master, text='Error Type:', font=font)
        self.l_battery.place(x=80, y=170)
        self.e_battery = Entry(self.master, font=font)
        self.e_battery.insert(0, self.record.Errortype)
        self.e_battery.configure(state='readonly')
        self.e_battery.place(x=200, y=170, width=300)
        ...
        self.l_time.place(x=80, y=270)
        self.e_time = Entry(self.master, font=font)
        self.e_time.insert(0, self.record.Time)
        self.e_time.configure(state='readonly')
        self.e_time.place(x=200, y=270, width=300)
...
class RepairHistoryTable(ttk.Treeview, Repair):
    ...
    def __init__(self, master, columns,
                 comb_date="2023-10-22", comb_type="Wheel") -> None:
        super().__init__(
            master=master,
            columns=columns,
            show='headings',
    ...
    def getRepairHistoryData(self):
        ...
        OData = repairhistoryList.get_loginData()
        OID = OData[2]
        repair_Hist_Data = repairhistoryList.get_repairHistory(self.cd, self.ct,OID)
        print(self.cd)
        print(self.ct)
        print(repair_Hist_Data)
