...
class LoginUI:
    ...
    def __init__(self) -> None:
        ...
        self.button_customer.place(x=S_W * (450 / 1440), y=S_H * (300 / 900), width=WIDTH, height=HEIGHT)
        self.button_operator.place(x=S_W * (630 / 1440), y=S_H * (300 / 900), width=WIDTH, height=HEIGHT)
        self.button_manager.place(x=S_W * (810 / 1440), y=S_H * (300 / 900), width=WIDTH, height=HEIGHT)
    ...
    def login(self,item):
        if item =="1":
            self.login_user = "1"
            self.change_color(self.button_customer, "lightpink")
        elif item =="2":
            self.login_user = "2"
            self.change_color(self.button_operator, "lightpink")
        elif item =="3":
            self.login_user = "3"
            self.change_color(self.button_manager, "lightpink")
